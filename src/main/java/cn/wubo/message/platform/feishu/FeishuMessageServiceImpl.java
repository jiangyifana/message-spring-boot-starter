...
//        headers.put(RECEIVE_ID_TYPE,
//                Lists.newArrayList((String) content.getParams().getFeishuMessage().get(RECEIVE_ID_TYPE)));
        ...
        try {
            ...
            CreateMessageResp resp = client.im()
                    ...
                    .create(CreateMessageReq.newBuilder()
                            .receiveIdType((String) content.getParams().getFeishuMessage().get(RECEIVE_ID_TYPE))
    ...
    public String sendText(FeishuProperties.Message aliasProperties, TextContent content) {
        ...
        // 设置请求头，包含消息接收者类型
//        Map<String, List<String>> headers = new HashMap<>();
//        headers.put(RECEIVE_ID_TYPE, Lists.newArrayList(
//                (String) content.getContentParams(aliasProperties.getAlias()).getFeishuMessage().get
//                (RECEIVE_ID_TYPE)));
//
        try {
            // @formatter:off
